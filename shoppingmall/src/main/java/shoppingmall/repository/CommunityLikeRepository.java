...
public class CommunityLikeRepository {
    ...
    public boolean hasUserLiked(String communityNum, Integer memberNum) {
    ...
    public void insertLike(String communityNum, Integer memberNum) {
        String sql = "INSERT INTO community_like (like_id, community_num, member_num) VALUES (community_like_seq.NEXTVAL, ?, ?)";
        jdbcTemplate.update(sql, communityNum, memberNum);
    }

    public void deleteLike(String communityNum, Integer memberNum) {
